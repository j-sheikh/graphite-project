...
**Upsampling** 
As discussed in Section 3 it is possible to upsample the data to improve prediction
performance. For this the user needs to provide the
absolute path to the csv files generated by transformdata-
toquantile.py as input, the number of how many
times the data should be upsampled at most, the number
of how many random states should be used and an absolute output path.
